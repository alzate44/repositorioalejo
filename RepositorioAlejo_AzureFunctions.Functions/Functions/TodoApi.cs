...
using RepositorioAlejo_AzureFunctions.Common.Models;
using RepositorioAlejo_AzureFunctions.Common.Responses;
using RepositorioAlejo_AzureFunctions.Functions.Entities;
using System;
using System.IO;
using System.Threading.Tasks;

namespace RepositorioAlejo_AzureFunctions.Functions.Functions
{
    public static class TodoApi
    {
            ...
            ILogger log)
        {
            ...
            {
                CreatedTime = DateTime.UtcNow, // Conversion de fecha en cualquier parte del mundo
                ETag = "*", // Particion horizontal de la tabla
                IsCompleted = false, //Tarea recién creada
                PartitionKey = "TODO", //Tabla donde lo vamos a guardar
                RowKey = Guid.NewGuid().ToString(),//Indice de la tabla
        ...
        public static async Task<IActionResult> UpdateTodo(
          [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "todo/{id}")] HttpRequest req,  //QUERY STRING LE MANDAMOS EL ID
          [Table("todo", Connection = "AzureWebJobsStorage")] CloudTable todoTable,
          string id,
          ILogger log)
        {
